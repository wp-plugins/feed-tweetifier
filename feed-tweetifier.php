...
function tweeder_admin_menu() {
	...
	echo '<div class="wrap">';
	echo '<div class="icon32" style="background-image:url(\'http://ollieparsley.com/wp-content/uploads/2009/05/icon.jpg\')"><br /></div>';
	echo '<h2>'.$tweeder_app_name.' Options</h2>';
	echo '<div style="float:right;padding:3px;margin;10px;border:1px #000000 solid;text-align:center;"><a href="'.get_bloginfo('url').'/?feed='.$tweeder_app_feed_name.'" target="_blank"><img src="http://ollieparsley.com/wp-content/uploads/2009/05/rss.jpg" alt="View the tweetified feed" style="text-decoration:none;" /><br />View the<br />tweetified feed</a></div>';
